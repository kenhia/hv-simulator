...
*source wikitext* (the junction's 'Known termini' list, distances, citation
...
(Sibling copy of the one in the system-/ship-scribe skills.)

Usage:
    python fetch_wikitext.py "Manticore Wormhole Junction"
    python fetch_wikitext.py "Asgard Wormhole Junction" --save _raw/asgard.wiki
"""
...
def main() -> None:
    ...
    ap.add_argument("title", help="exact page title, e.g. 'Manticore Wormhole Junction'")
    ap.add_argument(
        "--save",
        metavar="PATH",
